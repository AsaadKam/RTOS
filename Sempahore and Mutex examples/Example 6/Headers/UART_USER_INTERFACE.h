...
#define UART_RTOS_Not_New_Data 9
...
typedef uinteg8_t UART_Error_t ;
/***UART_ERRORs****/
...
#define UART_FreeRTOS_mode_enable	               11   
#define UART_Polling_mode_enable	               12 		
 ...
 * Output    : Error Checking
 *_______________________________________________________________________________________________________________________________*/
extern UART_Error_t UART_SendByte(uinteg8_t u8_Byte_UART);
/*_______________________________________________________________________________________________________________________________*/
 ...
 * Output    : Error Checking
 *_______________________________________________________________________________________________________________________________*/
extern UART_Error_t UART_SendString(uinteg8_t* pchar_index);
/*_______________________________________________________________________________________________________________________________*/
/*Description: It receives character from  UART
 * Input     : (char_t* pchar_index)It takes pointer to char
 * Output    : Error Checking
 *_______________________________________________________________________________________________________________________________*/
extern UART_Error_t UART_RecByte(uinteg8_t volatile * volatile pchar_index);
/*uinteg8_t UART_Print_Float(float32_t float32_FloatNumber);*/

/*- FUNCTION-LIKE MACROS -----------------------------------*/
#define UART_Print_Float(N)       UART_SendString(ConvertFloatToString(N))

uinteg8_t  UART_BYTE_TRASMITTED(void);

uinteg8_t  UART_BYTE_RECEIVED(void);
#endif